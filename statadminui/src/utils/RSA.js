...
(function ($w) {
  ...
  RSAUtils.biFromString = function (s, radix) {
    ...
    for (let i = s.length - 1; i >= istop; i--) {
      let c = s.charCodeAt(i),
        digit = RSAUtils.charToHex(c),
        biDigit = RSAUtils.biMultiplyDigit(place, digit);
  ...
  RSAUtils.biShiftLeft = function (x, n) {
    ...
    result.digits[0] = ((result.digits[j] << bits) & maxDigitVal);
    result.isNeg = x.isNeg;
    return result;
  };
  ...
  function BarrettMuModulo (x) {
    let $dmath = RSAUtils,
      q1 = $dmath.biDivideByRadixPower(x, this.k - 1),
      q2 = $dmath.biMultiply(q1, this.mu),
      q3 = $dmath.biDivideByRadixPower(q2, this.k + 1),
      r1 = $dmath.biModuloByRadixPower(x, this.k + 1),
      r2term = $dmath.biMultiply(q3, this.modulus),
      r2 = $dmath.biModuloByRadixPower(r2term, this.k + 1),
  ...
  RSAUtils.encryptedString = function (key, s) {
    ...
    for (i = 0; i < al; i += key.chunkSize) {
      ...
      let crypt = key.barrett.powMod(block, key.e),
        text = key.radix === 16 ? RSAUtils.biToHex(crypt) : RSAUtils.biToString(crypt, key.radix);
      result += text + ' ';
    }
...
export function encode (str) {
  ...
  var publicExponent = '',
    ...
    pubkey = new RSAUtils.getKeyPair(modulus, '', publicExponent);
  RSAUtils.setMaxDigits(130);
  return RSAUtils.encryptedString(pubkey, str);
}
