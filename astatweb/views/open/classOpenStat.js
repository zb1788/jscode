...
$(function() {// 初始化内容
	setTitle();
	var url = furl + warName + "/getOpenClazzList?school_id="+school_id+"&starttime="+starttime+"&endtime="+endtime;
	setTable(url);
...
function setTitle(){
	...
	$.ajax({
		...
		success: function(data){
			var zc = data[0].UserActiveInfo.studentNum;
			var jh = data[0].UserActiveInfo.loginstudentTimes;
			var jhl = "0%";
			if(zc != 0){
