...
<div>
  <!-- <div>
    <van-button style="float:right;" plain type="primary" @click="usercode">使用兑换码</van-button>
  </div>  
  ...
  <div class="order_list">
        <van-list v-model="loading"                  
          ...
          <van-panel v-for="(el, i) in orderList"
                     ...
                     :status="el.name"
                     style="border-bottom: solid 1px #c3bdbd;"
            ...
            <div class="total" style="font-size:1rem;">兑换码：{{el.activity_code}}</div>
...
export default {
  ...
  methods: {
    ...
    async getOrderList() {
      ...
      obj.action = 'query_order_activity';
    ...
    userOrder(el){      
      ...
      // this.showKefu = true;
      this.$router.push('/msg/collect/'+el.id)
    },
    delOrder(id) {
      let that = this;
      this.$dialog
