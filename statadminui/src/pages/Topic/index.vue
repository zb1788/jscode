...
import { delTopicsByIdList } from '@/api/canel';
...
export default {
  ...
  data () {
    return {
      ...
      operationViewList: [
        { id: '0', path: '/topic', label: 'Topic管理', __closeAble: false }
      ],
              ...
              return <div>
                <vcom-button
                  ...
                  onClick={async () => {
                    ...
                    const res = await delTopicsByIdList(idList.join(','));
                    if (res.code === '200') {
