...
export function checkWxBrower(isWexinBrower,self){
  if(isWexinBrower){
    self.$notify({ type: 'success', message: '点击右上角，选择在浏览器中打开',duration: 0 });
  }
}

//wx支付
const payUrl= 'v1.0/wx/payment';
...
const goodDetailUrl= '/v1.0/products';
...
const loginApiUrl= '/v1.0/members';
...
//获取手机验证码
const getCodeApiUrl= '/v1.0/members';
...
const registerApiUrl= '/v1.0/members';
...
const orderListApiUrl= '/v1.0/orders';
 ...
 * 填写使用人
 */
const submitUseApiUrl= '/v1.0/equities';
export function submitUseApi(data) {
  return request({
    url: submitUseApiUrl,
    method: 'post',
    data
...
const addOrderApiUrl= '/v1.0/orders';
